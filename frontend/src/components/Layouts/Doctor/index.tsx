...
import { MdHome, MdOutlineRequestPage } from "react-icons/md";
import { Link, Outlet, useLocation,useNavigate } from "react-router-dom";


const layoutName = "doctor";
export default function DoctorLayout() {
  ...
  if(location.pathname.includes("registration") || location.pathname.includes("thank-you") || location.pathname.includes("reject")){
    return <Outlet />
  }
