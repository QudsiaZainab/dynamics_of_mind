          ...
          <Card style={{ width: "30rem" }} className="just ">
            <div className="d-flex justify-content-center flex-direction-column ">
              <BsCheck
                size={32}
                color="green"
                className="border border-primary  mt-5 rounded-circle "
              />
            </div>
            <Card.Body>
              <Card.Title className="text-center text-success mt-4">
                Your Appointment is Booked.
              </Card.Title>
              <Card.Text className="pt-3">
                Your appointment is booked and our team will contact you as soon
                as possible.
              </Card.Text>
